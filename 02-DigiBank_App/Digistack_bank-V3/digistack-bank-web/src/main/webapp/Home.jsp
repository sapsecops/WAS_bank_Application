            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card db-card p-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <!-- =================================================
                             JDBC / DATASOURCE INFORMATION
                             ================================================= -->

                        <div class="db-jdbc-info mt-4">
                        ...
                        <p class="text-muted small mt-3 mb-0">
                            ...
                            Message retrieved from PostgreSQL using
                            a WebSphere-managed JDBC DataSource.
